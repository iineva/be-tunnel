...
module.exports = function createClient(config) {
    ...
    var tunnel_host = config.tunnelHost || '127.0.0.1';
    var tunnel_port = config.tunnelPort || 2121;
    var backend_host = config.backendHost || '127.0.0.1';
    var backend_port = config.backendPort || 80;
    ...
    client.connect(tunnel_port, tunnel_host, function() {
        ...
        // 发送注册包，通知服务器注册端口
        client.write(parseData.createBuffer(config.serviceName, parseData.type.register, {
